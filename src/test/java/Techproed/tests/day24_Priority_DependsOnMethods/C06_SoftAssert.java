...
public class C06_SoftAssert {
    /*
        SotfAssert kullanımında junitteki daha önce kullandığımız methodların aynısını kullanırız.
    Daha önceden kullandığımız assertion nerde hata alırsa orada testlerin çalışmasını durdurur.
    SoftAssert'te ne kadar assertion kullansak da nerde assertAll () methodu kullanırsak testlerimiz
    de kullandığımız assertion'lar arda sonlanır ve hata varsa bunu bize konsolda belirtir.
     */
        WebDriver driver;
    @BeforeMethod
    public void setUp() {
